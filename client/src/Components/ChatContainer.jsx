...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full w-full overflow-scroll relative backdrop-blur-lg'>
     {/* header part */}
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
         <img src={selectedUser.profilePic || assets.avatar_icon} alt='' className='w-8 rounded-full'></img>
         ...
         ></img>
         <img src={assets.help_icon} alt="" className='max-md:hidden max-w-5'></img>
      </div>
